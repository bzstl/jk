...
<li id="update"><a href="#" onclick="formSubmit('cancle.action','_self');this.blur();">取消</a></li>
</ul>
  </div>
</div>
</div>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${o.totalAmount}</td>
		<td>
			<c:if test="${o.state==1 }"><a href="cancle.action?id=${o.id}"><font color="green">已上报</font></a></c:if>
			<c:if test="${o.state==0 }"><a href="submit.action?id=${o.id}"><font color="red">草稿</font></a></c:if>
		</td>
