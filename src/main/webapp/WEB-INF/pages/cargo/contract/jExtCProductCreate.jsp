...
<li id="back"><a href="returnc.action?contractProductId=${contractProductId}">返回</a></li>
</ul>
    </div>
</div>
</div>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent">												
					 <input type="text" name="packingUnit" value=""/>		
				</td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="productDesc" value=""/></td>
	            <td class="columnTitle_mustbe">要求：</td>
	            <td class="tableContent"><input type="text" name="productRequest" value=""/></td>
	        </tr>
		</table>
	</div>
</div>
